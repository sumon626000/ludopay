  ...
  public void OnPreprocessBuild(BuildReport report) {
    ...
    if (oldAssetGuids != null && oldAssetGuids.Length > 0) {
      ...
      if (oldAsset != null) {
        ...
        // Skip if patched by FixFirebaseAndroidBuild (avoids undoing the quit() fix).
        if (oldFileContents.Contains("//mUnityPlayer.quit(); // Replaced as it causes a build error")) {
            return;
        }
