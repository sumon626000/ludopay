    ...
    <link rel="stylesheet" type="text/css" href="{{URL::asset('admin-assets/vendors/css/extensions/toastr.min.css')}}">
    <!-- END: Vendor CSS-->
    ...
    <link rel="stylesheet" type="text/css" href="{{URL::asset('admin-assets/vendors/css/forms/select/select2.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{URL::asset('admin-assets/vendors/css/parsleyjs/parsley.css')}}">
     ...
     <link rel="stylesheet" type="text/css" href="{{URL::asset('admin-assets/vendors/js/sweet-alert/jquery.sweet-modal.min.css')}}">
      <link rel="stylesheet" type="text/css" href="{{URL::asset('admin-assets/vendors/fancyuploder/fancy_fileupload.css')}}">
       <link rel="stylesheet" type="text/css" href="{{URL::asset('admin-assets/vendors/fileupload/css/fileupload.css')}}">

     <link rel="stylesheet" type="text/css" href="{{URL::asset('admin-assets/vendors/js/sweet-alert/sweetalert.css')}}">

    <!-- BEGIN: Page CSS-->
    <link rel="stylesheet" type="text/css" href="{{URL::asset('admin-assets/css/pages/dashboard-ecommerce.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{URL::asset('admin-assets/css/plugins/extensions/ext-component-toastr.min.css')}}">
    <!-- END: Page CSS-->
    @yield('css')
    <!-- BEGIN: Custom CSS-->
